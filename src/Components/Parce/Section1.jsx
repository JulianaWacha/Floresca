        ...
        <div class="px-4 py-5 my-5 text-center" id="parce1">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <form action="/Home/Parcerias#ongs" method="post"><button class="btn btn-outline-primary btn-lg px-4">Ongs Parceiras</button><input name="__RequestVerificationToken" type="hidden" value="CfDJ8ICARspdK2ZKvXBhTG9oSIU27v4ANh-e7sBqdENhgGspvJHMmKheP63ivttK2B4AhXbXMHHLtIS56YBvYNvEC3njF9znwpqGzOtBLBA3QsVCXhhlE28NQNy10JQWmVAiFyrVl66_KfpwSpY_uMEjobE"></input></form>
                    <form action="/Home/Parcerias#cadastro" method="post"><button class="btn btn-outline-primary btn-lg px-4">Faça seu Cadastro</button><input name="__RequestVerificationToken" type="hidden" value="CfDJ8ICARspdK2ZKvXBhTG9oSIU27v4ANh-e7sBqdENhgGspvJHMmKheP63ivttK2B4AhXbXMHHLtIS56YBvYNvEC3njF9znwpqGzOtBLBA3QsVCXhhlE28NQNy10JQWmVAiFyrVl66_KfpwSpY_uMEjobE"></input></form>
                </div>
            </div>
        </div>
    );
